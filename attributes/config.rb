...
default.redis.config.logfile         = "/var/log/redis/#{default.redis.instance_name}.log"
default.redis.config.loglevel        = "warning"
default.redis.config.pidfile         = "/var/run/redis/#{default.redis.instance_name}.pid"
...
default.redis.config.slaveof_port    = nil
